...
- **Architecture:** Enterprise & integration patterns, microservices, multi-partner systems  
- **Tech Stack:** Ruby on Rails, Kotlin, Java, Spring Boot, Node.js, RabbitMQ, Redis, Solidity, Elixir, Python  
- **Domains:** Marketplaces, Fintech, payments, health tech, social commerce, telco, media  
...
Kenya’s #1 managed used-car marketplace.  
- Directed Product, Engineering, and IT teams as part of the Executive Group  
- Delivered new web app, vehicle intake & assessment app, and unified internal systems  
- Drove automation in listings, yard management, and customer processes

---

### Bridge Technologies | Nairobi, Kenya  
**CTO & VP of Engineering** | Jul 2022 – Jan 2023  
Fintech platform delivering payments, remittances, and merchant services.  
- Designed API-first architecture for payments, remittances, wallets, and swaps  
- Delivered MTN Group cross-border remittance product (70M+ potential users)  
- Partnered with KCB for outbound remittances to Nigeria  
- Scaled engineering org, filled key roles, and introduced product roadmap  
...
### Kwara Ltd | Nairobi, Kenya  
**CTO** | Oct 2018 – May 2019  
Core banking platform for cooperative financial institutions.  
- Led team of 5 developers & designers  
- Delivered technical roadmap, architecture, and product enhancements  
...
- **Consultant** (2013–2016, Djibouti/Ghana/Kenya) – Delivered data platforms, e-commerce & trade finance systems  
- **Genkey Africa** (2010–2012, Ghana) – Lead Developer during national-scale, biometric voter registration software development; Ghana Electoral Commission (2012 presidential elections)
- **CoreNett Ltd** (2007–2010, Ghana) – Head of Software Development; delivered mobile wallet, cardless ATM, and voucher systems  
- **Rancard Solutions** (2006–2007, Ghana) – Product Manager; built SMS voting system for *West African Idols*  

---

## Education  
**Ashesi University, Ghana** – B.Sc. Computer Science (Cum Laude), 2005  
